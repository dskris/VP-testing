...
$driver->get("http://www.venuepoint.com.my");
...
$driver->findElement(Facebook\WebDriver\WebDriverBy::id('loginsigin'))->click();
sleep(1);
$driver->findElement(Facebook\WebDriver\WebDriverBy::id('email3'))->sendKeys('kris26ooi@gmail.com');
sleep(1);
$driver->findElement(Facebook\WebDriver\WebDriverBy::id('pass3'))->sendKeys('horse26');
sleep(1);
$driver->findElement(Facebook\WebDriver\WebDriverBy::id('sign1'))->click();
